...
public class UserController {
	...
	public ModelAndView uploads3(@RequestParam(name = "name") String name, @RequestParam(name = "bio") String desc,
		...
		try {
			...
			try {
				...
				// Make it 1 big JSON
				String bodyResponse = response.body().string();			// grab actual current weather
				String mainWeather = GetNestedWeatherJSON(bodyResponse, "main");
				Double mainTemp = GetNestedTempJSON(bodyResponse, "temp");
	...
	public String GetNestedWeatherJSON(String json, String target) {
		...
		String mainWeather = weatherJson.getString(target);
		return mainWeather;
	}

	public Double GetNestedTempJSON(String json, String target) {
		JSONObject obj = new JSONObject(json);
		Object temp = obj.get("main");
		String tempString = temp.toString();
		JSONObject tempJson = new JSONObject(tempString);
		Double targTemp = tempJson.getDouble(target);
		return targTemp;
	}
